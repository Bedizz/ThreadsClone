      ...
      <Stack
        ...
        <FormControl >
          ...
          <Stack direction={['column', 'row']} spacing={6}>
            <Center>
              <Avatar size="xl" boxShadow={"md"}  src={previewImage  || user.profilePic}>
                {/* <AvatarBadge
                  as={IconButton}
                  size="sm"
                  rounded="full"
        ...
        <FormControl  >
          ...
          <Input
            ...
            type="text" onChange={(e) => setForm({...form, name: e.target.value})}
            value={form.name}
          />
        </FormControl>
        <FormControl  >
        ...
        <FormControl  >
          ...
          <Input
            ...
            _placeholder={{ color: 'gray.500' }}
            type="text" onChange={(e) => setForm({...form, bio: e.target.value})}
            value={form.bio}
          />
        </FormControl>
        <FormControl  >
